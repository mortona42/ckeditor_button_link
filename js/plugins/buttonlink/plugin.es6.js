...
(function ($, Drupal, drupalSettings, CKEDITOR) {
  ...
  CKEDITOR.plugins.add('buttonlink', {
    ...
    init(editor) {
      ...
      editor.addCommand('buttonlink', {
        ...
        exec(editor) {
          ...
          const dialogSettings = {
            title: linkElement ? editor.config.buttonLink_dialogTitleEdit : editor.config.buttonLink_dialogTitleAdd,
      ...
      // CTRL + K.
      editor.setKeystroke(CKEDITOR.CTRL + 75, 'buttonlink');
      ...
      if (editor.ui.addButton) {
        ...
        editor.ui.addButton('ButtonUnlink', {
          label: Drupal.t('Unlink'),
          command: 'buttonunlink',
        });
      }
      ...
      editor.on('doubleclick', (evt) => {
        ...
        if (!element.isReadOnly()) {
          if (element.is('a')) {
            ...
            editor.getCommand('buttonlink').exec();
          }
        }
      });
  ...
  // Expose an API for other plugins to interact with buttonlink widgets.
  // (Compatible with the official CKEditor link plugin's API:
  // http://dev.ckeditor.com/ticket/13885.)
  CKEDITOR.plugins.buttonlink = {
